...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> approve(Boolean approved, long userId, Long bookingId) {
    ...
    public ResponseEntity<Object> addBooking(long userId, BookingDtoInput booking) {
